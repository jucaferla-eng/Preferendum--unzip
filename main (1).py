...
def seed(db: Session = Depends(get_db)):
    ...
    debates_data = [
        {'title': 'Plan de inversion presupuesto municipal 2027', 'description': 'La Municipalidad de Las Condes necesita definir las prioridades de inversion para el presupuesto 2027. Como vecino, tu voz es decisiva.', 'institution': 'Municipalidad Las Condes', 'inst_type': 'gov', 'options': ['Infraestructura vial', 'Salud publica', 'Educacion', 'Areas verdes']},
        {'title': 'Plan de movilidad urbana Santiago 2027', 'description': 'Para reducir la congestion y mejorar la calidad de vida en Santiago necesitamos decidir la prioridad en transporte publico.', 'institution': 'Municipalidad Santiago', 'inst_type': 'gov', 'options': ['Metro ampliado', 'Ciclovias', 'Buses electricos', 'Autopistas']},
